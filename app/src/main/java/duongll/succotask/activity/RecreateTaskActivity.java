        ...
        if (message.equals("modify")) {
            ...
            taskCall.enqueue(new Callback<CreateTaskDto>() {
                ...
                public void onResponse(Call<CreateTaskDto> call, Response<CreateTaskDto> response) {
                    if (response.code() == 200) {
                        Toast.makeText(RecreateTaskActivity.this, "Reassign successfully", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        Toast.makeText(RecreateTaskActivity.this, "Reassign failed", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
            ...
            taskCall.enqueue(new Callback<CreateTaskDto>() {
                ...
                public void onResponse(Call<CreateTaskDto> call, Response<CreateTaskDto> response) {
                    if (response.code() == 200) {
                        Toast.makeText(RecreateTaskActivity.this, "Create successfully", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        Toast.makeText(RecreateTaskActivity.this, "Create failed", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
