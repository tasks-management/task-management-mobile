        ...
        listTaskCall.enqueue(new Callback<List<Task>>() {
            ...
            public void onResponse(Call<List<Task>> call, Response<List<Task>> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(AdminIndexActivity.this, "Cannot found task list from that user id", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            ...
            public void onFailure(Call<List<Task>> call, Throwable t) {
                Toast.makeText(AdminIndexActivity.this, "Cannot connect to server", Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
